...
try {
    if (isset($_POST['Nueva_leyenda'])) {
        $Nueva_leyenda = $_POST['Nueva_leyenda'];

        $query = "UPDATE catalogo_configuracion SET Leyenda_Departamento=?";
        
        // Prepara la sentencia SQL
        $stmt = $mysqli->prepare($query);

        // Vincula los parámetros a los marcadores de posición
        $stmt->bind_param("s", $Nueva_leyenda);
