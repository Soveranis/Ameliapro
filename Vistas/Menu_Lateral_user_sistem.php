                    ...
                    <ul class="lists">
                        <li class="list">
                            <a href="ptn_sist_inicio.php" class="nav-link ">
                                ...
                                <span class="link">Eventos Log</span>
                            </a>
                        </li>
                        <li class="list">
                        ...
                        <li class="list">
                            <a href="ptn_sist_logos.php" class="nav-link">
                                ...
                                <span class="link"> Personalizar</span>
                            </a>
                        </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="Conten_user">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icono_usuario" viewBox="0 0 532 532"
                            xmlns:xlink="http://www.w3.org/1999/xlink" style="margin-top: -21px;">
                            <circle cx="270.75986" cy="260.93427" r="86.34897" fill="#ffb6b6" />
                            <polygon
