    ...
    <div class="container-fluid">
        <div id="navbar-menu">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <div class="alert alert-warning">
                            La orden de pago con el folio PT-322 está a punto de caducar. Por favor, contacte con el titular.
                        </div>
                ...
                <li class="dropdown">
                    <a href="../User_Pante/ptn_manual_usuario.php" class="dropdown-toggle">
                        <i class="lnr lnr-question-circle"></i>
            ...
            <div class="sidebar">
                <div class="sidebar-content">
                    ...
                    <div style="padding-left: 0px;">
                        <ul class="lists" style="font-size: 19px;">
                            <li class="list">
                            ...
                            ?>
                                <li class="list">
                                    <a href="ptn_pante_titulares.php" class="nav-link ">
                                        ...
                                        <span class="link">Titulares</span>
                                    </a>
                                </li>
                            <?php
                            }
                            ...
                            ?>
                                <li class="list">
                                    <a href="ptn_pante_consultas.php" class="nav-link">
                                        ...
                                        <span class="link">Reporte General</span>
                                    </a>
                                </li>
                            <?php
                            }
                            ...
                            ?>
                                <li class="list">
                                    <a href="ptn_pante_panteones.php" class="nav-link">
                                        ...
                                        <span class="link">Panteones</span>
                                    </a>
                                </li>
                            <?php
                            }
...
<div class="modal fade" id="Cerrar_sesion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>¿Seguro que deseas cerrar sesion?</center>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                <a type="button" href="cerrar_sesion/cerrar_sesion.php" class="btn btn-primary">Cerrar sesion</a>
            </div>
        </div>
    </div>
</div>